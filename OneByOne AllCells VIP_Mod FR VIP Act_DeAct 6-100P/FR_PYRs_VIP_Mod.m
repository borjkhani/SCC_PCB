...
H_VIP_Act_06P_PYRs(H_VIP_Act_06P_PYRs>Thr)=NaN;
H_VIP_Act_12P_PYRs(H_VIP_Act_12P_PYRs>Thr)=NaN;
H_VIP_Act_18P_PYRs(H_VIP_Act_18P_PYRs>Thr)=NaN;
H_VIP_Act_25P_PYRs(H_VIP_Act_25P_PYRs>Thr)=NaN;
H_VIP_Act_50P_PYRs(H_VIP_Act_50P_PYRs>Thr)=NaN;
H_VIP_Act_75P_PYRs(H_VIP_Act_75P_PYRs>Thr)=NaN;
H_VIP_Act_100P_PYRs(H_VIP_Act_100P_PYRs>Thr)=NaN;

H_VIP_DeAct_06P_PYRs(H_VIP_DeAct_06P_PYRs>Thr)=NaN;
H_VIP_DeAct_12P_PYRs(H_VIP_DeAct_12P_PYRs>Thr)=NaN;
H_VIP_DeAct_18P_PYRs(H_VIP_DeAct_18P_PYRs>Thr)=NaN;
H_VIP_DeAct_25P_PYRs(H_VIP_DeAct_25P_PYRs>Thr)=NaN;
H_VIP_DeAct_50P_PYRs(H_VIP_DeAct_50P_PYRs>Thr)=NaN;
H_VIP_DeAct_75P_PYRs(H_VIP_DeAct_75P_PYRs>Thr)=NaN;
H_VIP_DeAct_100P_PYRs(H_VIP_DeAct_100P_PYRs>Thr)=NaN;
...
H_C1_PYRs=H_C_PYRs;
H_VIP_Act_06P1_PYRs=H_VIP_Act_06P_PYRs;
H_VIP_Act_12P1_PYRs=H_VIP_Act_12P_PYRs;
H_VIP_Act_18P1_PYRs=H_VIP_Act_18P_PYRs;
H_VIP_Act_25P1_PYRs=H_VIP_Act_25P_PYRs;
H_VIP_Act_50P1_PYRs=H_VIP_Act_50P_PYRs;
H_VIP_Act_75P1_PYRs=H_VIP_Act_75P_PYRs;
H_VIP_Act_100P1_PYRs=H_VIP_Act_100P_PYRs;

H_VIP_DeAct_06P1_PYRs=H_VIP_DeAct_06P_PYRs;
H_VIP_DeAct_12P1_PYRs=H_VIP_DeAct_12P_PYRs;
H_VIP_DeAct_18P1_PYRs=H_VIP_DeAct_18P_PYRs;
H_VIP_DeAct_25P1_PYRs=H_VIP_DeAct_25P_PYRs;
H_VIP_DeAct_50P1_PYRs=H_VIP_DeAct_50P_PYRs;
H_VIP_DeAct_75P1_PYRs=H_VIP_DeAct_75P_PYRs;
H_VIP_DeAct_100P1_PYRs=H_VIP_DeAct_100P_PYRs;
...
H_VIP_Act_06P1_PYRs=H_VIP_Act_06P1_PYRs(~isnan(H_VIP_Act_06P1_PYRs));
H_VIP_Act_12P1_PYRs= H_VIP_Act_12P1_PYRs(~isnan(H_VIP_Act_12P1_PYRs));
H_VIP_Act_18P1_PYRs= H_VIP_Act_18P1_PYRs(~isnan(H_VIP_Act_18P1_PYRs));
H_VIP_Act_25P1_PYRs= H_VIP_Act_25P1_PYRs(~isnan(H_VIP_Act_25P1_PYRs));
H_VIP_Act_50P1_PYRs= H_VIP_Act_50P1_PYRs(~isnan(H_VIP_Act_50P1_PYRs));
H_VIP_Act_75P1_PYRs= H_VIP_Act_75P1_PYRs(~isnan(H_VIP_Act_75P1_PYRs));
H_VIP_Act_100P1_PYRs= H_VIP_Act_100P1_PYRs(~isnan(H_VIP_Act_100P1_PYRs));
H_VIP_DeAct_06P1_PYRs= H_VIP_DeAct_06P1_PYRs(~isnan(H_VIP_DeAct_06P1_PYRs));
H_VIP_DeAct_12P1_PYRs= H_VIP_DeAct_12P1_PYRs(~isnan(H_VIP_DeAct_12P1_PYRs));
H_VIP_DeAct_18P1_PYRs= H_VIP_DeAct_18P1_PYRs(~isnan(H_VIP_DeAct_18P1_PYRs));
H_VIP_DeAct_25P1_PYRs= H_VIP_DeAct_25P1_PYRs(~isnan(H_VIP_DeAct_25P1_PYRs));
H_VIP_DeAct_50P1_PYRs= H_VIP_DeAct_50P1_PYRs(~isnan(H_VIP_DeAct_50P1_PYRs));
H_VIP_DeAct_75P1_PYRs= H_VIP_DeAct_75P1_PYRs(~isnan(H_VIP_DeAct_75P1_PYRs));
H_VIP_DeAct_100P1_PYRs= H_VIP_DeAct_100P1_PYRs(~isnan(H_VIP_DeAct_100P1_PYRs));


 M1=mean(H_C1_PYRs(~isnan(H_C1_PYRs)));
 M2=mean(H_VIP_Act_06P1_PYRs(~isnan(H_VIP_Act_06P1_PYRs)));
 M3=mean(H_VIP_Act_12P1_PYRs(~isnan(H_VIP_Act_12P1_PYRs)));
 M4=mean(H_VIP_Act_18P1_PYRs(~isnan(H_VIP_Act_18P1_PYRs)));
 M5=mean(H_VIP_Act_25P1_PYRs(~isnan(H_VIP_Act_25P1_PYRs)));
 M6=mean(H_VIP_Act_50P1_PYRs(~isnan(H_VIP_Act_50P1_PYRs)));
 M7=mean(H_VIP_Act_75P1_PYRs(~isnan(H_VIP_Act_75P1_PYRs)));
 M8=mean(H_VIP_Act_100P1_PYRs(~isnan(H_VIP_Act_100P1_PYRs)));
 M9=mean(H_VIP_DeAct_06P1_PYRs(~isnan(H_VIP_DeAct_06P1_PYRs)));
 M10=mean(H_VIP_DeAct_12P1_PYRs(~isnan(H_VIP_DeAct_12P1_PYRs)));
 M11=mean(H_VIP_DeAct_18P1_PYRs(~isnan(H_VIP_DeAct_18P1_PYRs)));
 M12=mean(H_VIP_DeAct_25P1_PYRs(~isnan(H_VIP_DeAct_25P1_PYRs)));
 M13=mean(H_VIP_DeAct_50P1_PYRs(~isnan(H_VIP_DeAct_50P1_PYRs)));
 M14=mean(H_VIP_DeAct_75P1_PYRs(~isnan(H_VIP_DeAct_75P1_PYRs)));
 M15=mean(H_VIP_DeAct_100P1_PYRs(~isnan(H_VIP_DeAct_100P1_PYRs)));

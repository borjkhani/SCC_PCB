clearvars -except Pref_F_PYRs_PV_Act_100P PKS H_C H_Sst_Act_06P H_Sst_Act_12P H_Sst_Act_18P H_Sst_Act_25P H_Sst_Act_50P H_Sst_Act_75P H_Sst_Act_100P H_Sst_DeAct skipNum Gof_PYRs_C  Gof_PYRs_Sst_Act_06P Gof_PYRs_Sst_Act_12P Gof_PYRs_Sst_Act_18P Gof_PYRs_Sst_Act_25P Gof_PYRs_Sst_Act_50P Gof_PYRs_Sst_Act_75P Gof_PYRs_Sst_Act_100P Gof_PYRs_Sst_DeAct H_Sst_DeAct_06P H_Sst_DeAct_12P H_Sst_DeAct_18P H_Sst_DeAct_25P H_Sst_DeAct_50P H_Sst_DeAct_75P H_Sst_DeAct_100P  Gof_PYRs_Sst_DeAct_06P Gof_PYRs_Sst_DeAct_12P Gof_PYRs_Sst_DeAct_18P Gof_PYRs_Sst_DeAct_25P Gof_PYRs_Sst_DeAct_50P Gof_PYRs_Sst_DeAct_75P Gof_PYRs_Sst_DeAct_100P PKS_C PKS_Sst_Act_06P PKS_Sst_Act_12P PKS_Sst_Act_18P PKS_Sst_Act_25P PKS_Sst_Act_50P PKS_Sst_Act_75P PKS_Sst_Act_100P  PKS_Sst_DeAct_06P PKS_Sst_DeAct_12P PKS_Sst_DeAct_18P PKS_Sst_DeAct_25P PKS_Sst_DeAct_50P PKS_Sst_DeAct_75P PKS_Sst_DeAct_100P 
...
BB_Sst_Act_06P=mean(FB_Sst_Act_06P,3);
%%
...
BB_Sst_Act_12P=mean(FB_Sst_Act_12P,3);
%%
...
BB_Sst_Act_18P=mean(FB_Sst_Act_18P,3);
...
BB_Sst_Act_25P=mean(FB_Sst_Act_25P,3);
%
% x = 1:17; 
...
BB_Sst_Act_50P=mean(FB_Sst_Act_50P,3);
%
% x = 1:17; 
...
BB_Sst_Act_75P=mean(FB_Sst_Act_75P,3);
%
% x = 1:17; 
...
BB_Sst_Act_100P=mean(FB_Sst_Act_100P,3);
%
% x = 1:17; 
% N = size(BB_Sst_Act_100P,1);
% y = mean(BB_Sst_Act_100P);
% SEM = std(BB_Sst_Act_100P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% %errorbar(x, y, CI95,'o','LineWidth',3);
% grid off
% hold on;
...
BB_Sst_DeAct_06P=mean(FB_Sst_DeAct_06P,3);
%%
...
BB_Sst_DeAct_12P=mean(FB_Sst_DeAct_12P,3);
%%
...
BB_Sst_DeAct_18P=mean(FB_Sst_DeAct_18P,3);
...
BB_Sst_DeAct_25P=mean(FB_Sst_DeAct_25P,3);
%
% x = 1:17; 
...
BB_Sst_DeAct_50P=mean(FB_Sst_DeAct_50P,3);
%
% x = 1:17; 
...
BB_Sst_DeAct_75P=mean(FB_Sst_DeAct_75P,3);
%
% x = 1:17; 
...
BB_Sst_DeAct_100P=mean(FB_Sst_DeAct_100P,3);
%
% x = 1:17; 
...
if all(BB_Sst_Act_06P<=0)
    BB_Sst_Act_06P=BB_Control;
end

if all(BB_Sst_Act_12P<=0)
    BB_Sst_Act_12P=BB_Control;
end

if all(BB_Sst_Act_18P<=0)
    BB_Sst_Act_18P=BB_Control;
end

PP=0;
if all(BB_Sst_Act_25P<=0)
    BB_Sst_Act_25P=BB_Control;
end

PP=0;
if all(BB_Sst_Act_50P<=0)
    BB_Sst_Act_50P=BB_Control;
end

PP=0;
if all(BB_Sst_Act_75P<=0)
    BB_Sst_Act_75P=BB_Control;
end


PP=0;
if all(BB_Sst_Act_100P<=0)
    BB_Sst_Act_100P=BB_Control;
end

if all(BB_Sst_DeAct_06P<=0)
    BB_Sst_DeAct_06P=BB_Control;
end

if all(BB_Sst_DeAct_12P<=0)
    BB_Sst_DeAct_12P=BB_Control;
end

if all(BB_Sst_DeAct_18P<=0)
    BB_Sst_DeAct_18P=BB_Control;
end

PP=0;
if all(BB_Sst_DeAct_25P<=0)
    BB_Sst_DeAct_25P=BB_Control;
end

PP=0;
if all(BB_Sst_DeAct_50P<=0)
    BB_Sst_DeAct_50P=BB_Control;
end

PP=0;
if all(BB_Sst_DeAct_75P<=0)
    BB_Sst_DeAct_75P=BB_Control;
end


PP=0;
if all(BB_Sst_DeAct_100P<=0)
    BB_Sst_DeAct_100P=BB_Control;
end
...
BB_Sst_Act_06P(isnan(BB_Sst_Act_06P))=0;
BB_Sst_Act_12P(isnan(BB_Sst_Act_12P))=0;
BB_Sst_Act_18P(isnan(BB_Sst_Act_18P))=0;
BB_Sst_Act_25P(isnan(BB_Sst_Act_25P))=0;
BB_Sst_Act_50P(isnan(BB_Sst_Act_50P))=0;
BB_Sst_Act_75P(isnan(BB_Sst_Act_75P))=0;
BB_Sst_Act_100P(isnan(BB_Sst_Act_100P))=0;

BB_Sst_DeAct_06P(isnan(BB_Sst_DeAct_06P))=0;
BB_Sst_DeAct_12P(isnan(BB_Sst_DeAct_12P))=0;
BB_Sst_DeAct_18P(isnan(BB_Sst_DeAct_18P))=0;
BB_Sst_DeAct_25P(isnan(BB_Sst_DeAct_25P))=0;
BB_Sst_DeAct_50P(isnan(BB_Sst_DeAct_50P))=0;
BB_Sst_DeAct_75P(isnan(BB_Sst_DeAct_75P))=0;
BB_Sst_DeAct_100P(isnan(BB_Sst_DeAct_100P))=0;
...
yy=mean(BB_Sst_Act_06P);
[f_PYRs_Sst_Act_06P, gof_PYRs_Sst_Act_06P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_Act_12P);
[f_PYRs_Sst_Act_12P, gof_PYRs_Sst_Act_12P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_Act_18P);
[f_PYRs_Sst_Act_18P, gof_PYRs_Sst_Act_18P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_Act_25P);
[f_PYRs_Sst_Act_25P, gof_PYRs_Sst_Act_25P] = fit(xx.',yy.','gauss1');
%P2=plot(f_PYRs_Sst_Act_25P);
% hold on;

yy=mean(BB_Sst_Act_50P);
[f_PYRs_Sst_Act_50P, gof_PYRs_Sst_Act_50P] = fit(xx.',yy.','gauss1');
%P3=plot(f_PYRs_Sst_Act_50P);
% hold on;

yy=mean(BB_Sst_Act_75P);
[f_PYRs_Sst_Act_75P, gof_PYRs_Sst_Act_75P] = fit(xx.',yy.','gauss1');
%P4=plot(f_PYRs_Sst_Act_75P);
% hold on;

yy=mean(BB_Sst_Act_100P);
[f_PYRs_Sst_Act_100P, gof_PYRs_Sst_Act_100P] = fit(xx.',yy.','gauss1');
%P5=plot(f_PYRs_Sst_Act_100P);
% hold on;


yy=mean(BB_Sst_DeAct_06P);
[f_PYRs_Sst_DeAct_06P, gof_PYRs_Sst_DeAct_06P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_DeAct_12P);
[f_PYRs_Sst_DeAct_12P, gof_PYRs_Sst_DeAct_12P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_DeAct_18P);
[f_PYRs_Sst_DeAct_18P, gof_PYRs_Sst_DeAct_18P] = fit(xx.',yy.','gauss1');

yy=mean(BB_Sst_DeAct_25P);
[f_PYRs_Sst_DeAct_25P, gof_PYRs_Sst_DeAct_25P] = fit(xx.',yy.','gauss1');
%P2=plot(f_PYRs_Sst_DeAct_25P);
% hold on;

yy=mean(BB_Sst_DeAct_50P);
[f_PYRs_Sst_DeAct_50P, gof_PYRs_Sst_DeAct_50P] = fit(xx.',yy.','gauss1');
%P3=plot(f_PYRs_Sst_DeAct_50P);
% hold on;

yy=mean(BB_Sst_DeAct_75P);
[f_PYRs_Sst_DeAct_75P, gof_PYRs_Sst_DeAct_75P] = fit(xx.',yy.','gauss1');
%P4=plot(f_PYRs_Sst_DeAct_75P);
% hold on;

yy=mean(BB_Sst_DeAct_100P);
[f_PYRs_Sst_DeAct_100P, gof_PYRs_Sst_DeAct_100P] = fit(xx.',yy.','gauss1');
%P5=plot(f_PYRs_Sst_DeAct_100P);
% hold on;



%P6=plot(f_PYRs_Sst_DeAct);
% hold on;
...
%legend ('Control', 'Sst_A_c_t', 'Sst_D_e_A_c_t',  'Sst_A_c_t', 'Sst_D_e_A_c_t', 'Sst_A_c_t', 'Sst_D_e_A_c_t')

%legend ('Control', 'Sst_A_c_t', 'Sst_D_e_A_c_t')
%legend (['Control  (RMSE: ', num2str(gof_PYRs_C.rmse,2),')'],['Sst_A_c_t_2_5_%     (RMSE: ', num2str(gof_PYRs_Sst_Act_25P.rmse,2), ')'], ['Sst_A_c_t_5_0_%     (RMSE: ', num2str(gof_PYRs_Sst_Act_50P.rmse,2), ')'],['Sst_A_c_t_7_5_%     (RMSE: ', num2str(gof_PYRs_Sst_Act_75P.rmse,2), ')'],['Sst_A_c_t_1_0_0_%     (RMSE: ', num2str(gof_PYRs_Sst_Act_100P.rmse,2), ')'])

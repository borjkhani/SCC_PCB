...
save Med_PVs_Sst_Mod_Act.mat Med
...
mean1 = mean(H_Sst_Act_06P1_PVs);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_Sst_Act_12P1_PVs);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_Sst_Act_18P1_PVs);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_Sst_Act_25P1_PVs);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_Sst_Act_50P1_PVs);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_Sst_Act_75P1_PVs);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_Sst_Act_100P1_PVs);
...
saveas(gcf,'FR_L_PVs_Sst_Mod_Act_BW.tif')
saveas(gcf,'FR_L_PVs_Sst_Mod_Act_BW.png')
saveas(gcf,'FR_L_PVs_Sst_Mod_Act_BW.fig')
saveas(gcf,'FR_L_PVs_Sst_Mod_Act_BW.eps','psc2')
...
save Med_PVs_Sst_Mod_DeAct.mat Med
...
mean1 = mean(H_Sst_DeAct_06P1_PVs);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_Sst_DeAct_12P1_PVs);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_Sst_DeAct_18P1_PVs);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_Sst_DeAct_25P1_PVs);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_Sst_DeAct_50P1_PVs);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_Sst_DeAct_75P1_PVs);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_Sst_DeAct_100P1_PVs);
plot(8,mean7,'*','Color','g'); hold on;
...
%
t=text(1, 46, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
...
saveas(gcf,'FR_L_PVs_Sst_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_PVs_Sst_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_PVs_Sst_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_PVs_Sst_Mod_DeAct_BW.eps','psc2')

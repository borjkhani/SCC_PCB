...
global PKS_C;
global PKS_Sst_Act_06P;
global PKS_Sst_Act_12P;
global PKS_Sst_Act_18P;
global PKS_Sst_Act_25P;
global PKS_Sst_Act_50P;
global PKS_Sst_Act_75P;
global PKS_Sst_Act_100P;
global PKS_Sst_DeAct;
global PKS_Sst_DeAct_06P;
global PKS_Sst_DeAct_12P;
global PKS_Sst_DeAct_18P;
global PKS_Sst_DeAct_25P;
global PKS_Sst_DeAct_50P;
global PKS_Sst_DeAct_75P;
global PKS_Sst_DeAct_100P;
...
PKS_C = zeros(510,1);
PKS_Sst_Act_06P = zeros(510,1);
PKS_Sst_Act_12P = zeros(510,1);
PKS_Sst_Act_18P = zeros(510,1);
PKS_Sst_Act_25P = zeros(510,1);
PKS_Sst_Act_50P = zeros(510,1);
PKS_Sst_Act_75P = zeros(510,1);
PKS_Sst_Act_100P = zeros(510,1);
PKS_Sst_DeAct = zeros(510,1);
PKS_Sst_DeAct_06P = zeros(510,1);
PKS_Sst_DeAct_12P = zeros(510,1);
PKS_Sst_DeAct_18P = zeros(510,1);
PKS_Sst_DeAct_25P = zeros(510,1);
PKS_Sst_DeAct_50P = zeros(510,1);
PKS_Sst_DeAct_75P = zeros(510,1);
PKS_Sst_DeAct_100P = zeros(510,1);
...
F_PYRs_Sst_Act_06P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_12P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_18P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_25P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_50P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_75P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_Act_100P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_06P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_12P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_18P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_25P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_50P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_75P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_Sst_DeAct_100P_R =  A1*exp(-((X-B1)/C1).^2);
...
pks = findpeaks(F_PYRs_Sst_Act_06P_R);
if ~isnan(pks)
PKS_Sst_Act_06P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_06P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_12P_R);
if ~isnan(pks)
PKS_Sst_Act_12P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_12P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_18P_R);
if ~isnan(pks)
PKS_Sst_Act_18P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_18P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_25P_R);
if ~isnan(pks)
PKS_Sst_Act_25P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_25P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_50P_R);
if ~isnan(pks)
PKS_Sst_Act_50P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_50P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_75P_R);
if ~isnan(pks)
PKS_Sst_Act_75P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_75P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_Act_100P_R);
if ~isnan(pks)
PKS_Sst_Act_100P(Cell_Number,1) = pks;
else
    PKS_Sst_Act_100P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_06P_R);
if ~isnan(pks)
PKS_Sst_DeAct_06P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_06P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_12P_R);
if ~isnan(pks)
PKS_Sst_DeAct_12P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_12P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_18P_R);
if ~isnan(pks)
PKS_Sst_DeAct_18P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_18P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_25P_R);
if ~isnan(pks)
PKS_Sst_DeAct_25P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_25P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_50P_R);
if ~isnan(pks)
PKS_Sst_DeAct_50P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_50P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_75P_R);
if ~isnan(pks)
PKS_Sst_DeAct_75P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_75P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_Sst_DeAct_100P_R);
if ~isnan(pks)
PKS_Sst_DeAct_100P(Cell_Number,1) = pks;
else
    PKS_Sst_DeAct_100P(Cell_Number,1) = NaN;
end
...
save FR_Preferred.mat PKS_C PKS_Sst_Act_06P PKS_Sst_Act_12P PKS_Sst_Act_18P PKS_Sst_Act_25P PKS_Sst_Act_50P PKS_Sst_Act_75P PKS_Sst_Act_100P  PKS_Sst_DeAct_06P PKS_Sst_DeAct_12P PKS_Sst_DeAct_18P PKS_Sst_DeAct_25P PKS_Sst_DeAct_50P PKS_Sst_DeAct_75P PKS_Sst_DeAct_100P
save HWHH_Sst_Act_DeAct.mat H_C  H_Sst_Act_06P H_Sst_Act_12P H_Sst_Act_18P H_Sst_Act_25P H_Sst_Act_50P H_Sst_Act_75P H_Sst_Act_100P H_Sst_DeAct_06P H_Sst_DeAct_12P H_Sst_DeAct_18P H_Sst_DeAct_25P H_Sst_DeAct_50P H_Sst_DeAct_75P H_Sst_DeAct_100P

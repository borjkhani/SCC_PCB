...
box off
%%
load('Med_PYRs_PV_Mod_DeAct.mat')
y1 = Med; %x + randn(1,10);
ax1 = subplot(3,2,2);
sz = 140;
scatter(ax1,x,y1,sz,'filled'); %alpha(.7); axis tight;
...
saveas(gcf,'CA_PV_Mod.tif')
saveas(gcf,'CA_PV_Mod.fig')
saveas(gcf,'CA_PV_Mod.eps','psc2')
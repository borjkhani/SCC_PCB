...
MM_PV_Act_06P(ii)=(max(Firings_PV_Act_06P{ii, jj}));
MM_PV_Act_12P(ii)=(max(Firings_PV_Act_12P{ii, jj}));
MM_PV_Act_18P(ii)=(max(Firings_PV_Act_18P{ii, jj}));
MM_PV_Act_25P(ii)=(max(Firings_PV_Act_25P{ii, jj}));
MM_PV_Act_50P(ii)=(max(Firings_PV_Act_50P{ii, jj}));
MM_PV_Act_75P(ii)=(max(Firings_PV_Act_75P{ii, jj}));
MM_PV_Act_100P(ii)=(max(Firings_PV_Act_100P{ii, jj}));

MM_PV_DeAct_06P(ii)=(max(Firings_PV_DeAct_06P{ii, jj}));
MM_PV_DeAct_12P(ii)=(max(Firings_PV_DeAct_12P{ii, jj}));
MM_PV_DeAct_18P(ii)=(max(Firings_PV_DeAct_18P{ii, jj}));
MM_PV_DeAct_25P(ii)=(max(Firings_PV_DeAct_25P{ii, jj}));
MM_PV_DeAct_50P(ii)=(max(Firings_PV_DeAct_50P{ii, jj}));
MM_PV_DeAct_75P(ii)=(max(Firings_PV_DeAct_75P{ii, jj}));
MM_PV_DeAct_100P(ii)=(max(Firings_PV_DeAct_100P{ii, jj}));

end
Avg_C(jj)=mean(MM_C);

Avg_PV_Act_06P(jj)=mean(MM_PV_Act_06P);
Avg_PV_Act_12P(jj)=mean(MM_PV_Act_12P);
Avg_PV_Act_18P(jj)=mean(MM_PV_Act_18P);
Avg_PV_Act_25P(jj)=mean(MM_PV_Act_25P);
Avg_PV_Act_50P(jj)=mean(MM_PV_Act_50P);
Avg_PV_Act_75P(jj)=mean(MM_PV_Act_75P);
Avg_PV_Act_100P(jj)=mean(MM_PV_Act_100P);

Avg_PV_DeAct_06P(jj)=mean(MM_PV_DeAct_06P);
Avg_PV_DeAct_12P(jj)=mean(MM_PV_DeAct_12P);
Avg_PV_DeAct_18P(jj)=mean(MM_PV_DeAct_18P);
Avg_PV_DeAct_25P(jj)=mean(MM_PV_DeAct_25P);
Avg_PV_DeAct_50P(jj)=mean(MM_PV_DeAct_50P);
Avg_PV_DeAct_75P(jj)=mean(MM_PV_DeAct_75P);
Avg_PV_DeAct_100P(jj)=mean(MM_PV_DeAct_100P);
...
%
save FR_L_PV_PV_Mod_Act_KW_St.mat p tbl stats c m h nms
filename = 'FR_L_PV_PV_Mod_Act_KW_St.xlsx';
...
%%
A_C  =  Avg_C;
A_06 =  Avg_PV_DeAct_06P;
A_12 =  Avg_PV_DeAct_12P
A_18 =  Avg_PV_DeAct_18P
A_25 =  Avg_PV_DeAct_25P
A_50 =  Avg_PV_DeAct_50P
A_75 =  Avg_PV_DeAct_75P
A_100 = Avg_PV_DeAct_100P
...
CC.Properties.VariableNames(1:7) = {'1st group','2nd group','Lower (95% confidence)','diff. est. group means','Upper (95% confidence)','P-values','P-value(all)'}
%
save FR_L_PV_PV_Mod_DeAct_KW_St.mat p tbl stats c m h nms
filename = 'FR_L_PV_PV_Mod_DeAct_KW_St.xlsx';
%writematrix(c,filename,'Sheet',1,'Range','D1')
writetable(CC,filename,'Sheet',1,'Range','D1')
%writetable(PP,filename,'Sheet',1,'Range','J2')

...
% %
% x = 1:17; 
% N = size(BB_PV_Act_06P,1);
% y = mean(BB_PV_Act_06P);
% SEM = std(BB_PV_Act_06P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% errorbar(x, y, CI95,'o','LineWidth',3);
% grid off
% hold on;
...
% %
% x = 1:17; 
% N = size(BB_PV_Act_12P,1);
% y = mean(BB_PV_Act_12P);
% SEM = std(BB_PV_Act_12P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% errorbar(x, y, CI95,'o','LineWidth',3);
% grid off
% hold on;
...
% %
% x = 1:17; 
% N = size(BB_PV_Act_18P,1);
% y = mean(BB_PV_Act_18P);
% SEM = std(BB_PV_Act_18P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% errorbar(x, y, CI95,'o','LineWidth',3);
% grid off
% hold on;
...
% SEM = std(BB_PV_Act_06P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X2=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_12P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X3=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_18P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X4=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_25P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X5=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_50P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X6=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_75P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X7=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% SEM = std(BB_PV_Act_100P) / sqrt(N);                    % Standard Error Of The Mean
% CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
% X8=errorbar(x, y, CI95,'o','LineWidth',3);
% grid off;
% hold on;
% axis tight
% 
...
% X4(1).Color= [0.4660, 0.6740, 0.1880] % 18
% X5(1).Color= [0.9290, 0.6940, 0.1250]; % 25
% X6(1).Color= [0.8500, 0.3250, 0.0980]; % 50
% X7(1).Color= [0.6350, 0.0780, 0.1840] % 75
% X8(1).Color= [1, 0, 0] % 100
...
% P8(1).Color= [0.74,0.25,0.25] %'m' %0.47,0.67,0.19
% P9(1).Color= [0.87,0.45,0.75] %'m' %0.47,0.67,0.19

% P1(1).Color= [0, 0.4470, 0.7410]; %  Control

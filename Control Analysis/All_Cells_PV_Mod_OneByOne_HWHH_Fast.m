...
skipNum = [86,126,510]; %[24,506,PV,Sst];
%
...
% P3=plot(F_PYRs_PV_DeAct_100P); hold on;
...
% P6=plot(F_PYRs_PV_DeAct_100P); hold on;
% 
% P1(1).LineWidth = 4;
% P2(1).LineWidth = 4;
% P3(1).LineWidth = 4;
...
save HWHH_PV_Act.mat H_C  H_PV_Act_06P H_PV_Act_12P H_PV_Act_18P H_PV_Act_25P H_PV_Act_50P H_PV_Act_75P H_PV_Act_100P H_PV_DeAct_100P
save  Gof_PYRs_C  %Gof_PYRs_PV_Act_06P  Gof_PYRs_PV_Act_12P  Gof_PYRs_PV_Act_18P Gof_PYRs_PV_Act_25P Gof_PYRs_PV_Act_50P Gof_PYRs_PV_Act_75P Gof_PYRs_PV_Act_100P Gof_PYRs_PV_DeAct_100P 
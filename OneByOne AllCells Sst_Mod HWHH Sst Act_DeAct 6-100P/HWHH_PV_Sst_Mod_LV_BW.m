...
saveas(gcf,'L_PVs_Sst_Mod_Act_BW.tif')
saveas(gcf,'L_PVs_Sst_Mod_Act_BW.png')
saveas(gcf,'L_PVs_Sst_Mod_Act_BW.fig')
saveas(gcf,'L_PVs_Sst_Mod_Act_BW.eps','psc2')
...
saveas(gcf,'L_PVs_Sst_Mod_DeAct_BW.tif')
saveas(gcf,'L_PVs_Sst_Mod_DeAct_BW.png')
saveas(gcf,'L_PVs_Sst_Mod_DeAct_BW.fig')
saveas(gcf,'L_PVs_Sst_Mod_DeAct_BW.eps','psc2')

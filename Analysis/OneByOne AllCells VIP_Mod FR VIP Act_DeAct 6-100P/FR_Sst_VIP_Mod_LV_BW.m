...
if h_75==1
hold on
plot(xt([1 7]), [1 1]*max(yt)*1.145, '-k',  mean(xt([1 7])), max(yt)*1.155, '*k')
end
...
save Med_Sst_VIP_Mod_Act.mat Med
...
mean1 = mean(H_VIP_Act_06P1_Sst);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_VIP_Act_12P1_Sst);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_VIP_Act_18P1_Sst);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_VIP_Act_25P1_Sst);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_VIP_Act_50P1_Sst);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_VIP_Act_75P1_Sst);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_VIP_Act_100P1_Sst);
...
% t=text(1, 33, ['  Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 32, ['  r  = ' num2str(r(1,2))]);
% t=text(1, 31, ['  p = ' num2str(p(1,2))]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%
...
saveas(gcf,'FR_L_Sst_VIP_Mod_Act_BW.tif')
saveas(gcf,'FR_L_Sst_VIP_Mod_Act_BW.png')
saveas(gcf,'FR_L_Sst_VIP_Mod_Act_BW.fig')
saveas(gcf,'FR_L_Sst_VIP_Mod_Act_BW.eps','psc2')
%%
figure;
...
med1 = median(H_VIP_DeAct_06P1_Sst);
plot(2,med1,'ro-','Color','k'); hold on;

med2 = median(H_VIP_DeAct_12P1_Sst);
plot(3,med2,'ro-','Color','k'); hold on;

med3 = median(H_VIP_DeAct_18P1_Sst);
plot(4,med3,'ro-','Color','k'); hold on;

med4 = median(H_VIP_DeAct_25P1_Sst);
plot(5,med4,'ro-','Color','k'); hold on;

med5 = median(H_VIP_DeAct_50P1_Sst);
plot(6,med5,'ro-','Color','k'); hold on;

med6 = median(H_VIP_DeAct_75P1_Sst);
plot(7,med6,'ro-','Color','k'); hold on;

med7 = median(H_VIP_DeAct_100P1_Sst);
plot(8,med7,'ro-','Color','k'); hold on;



Med=[med  med1 med2 med3 med4 med5 med6 med7];
save Med_Sst_VIP_Mod_DeAct.mat Med
plot(Med,'Color','k','LineStyle',':','LineWidth',3 ); hold on;
...
mean1 = mean(H_VIP_DeAct_06P1_Sst);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_VIP_DeAct_12P1_Sst);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_VIP_DeAct_18P1_Sst);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_VIP_DeAct_25P1_Sst);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_VIP_DeAct_50P1_Sst);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_VIP_DeAct_75P1_Sst);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_VIP_DeAct_100P1_Sst);
plot(8,mean7,'*','Color','g'); hold on;
...
% t=text(1, 27, ['  Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 26, ['  r  = ' num2str(r(1,2))]);
% t=text(1, 25, ['  p = ' num2str(p(1,2))]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%
...
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'FR_L_Sst_VIP_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_Sst_VIP_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_Sst_VIP_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_Sst_VIP_Mod_DeAct_BW.eps','psc2')

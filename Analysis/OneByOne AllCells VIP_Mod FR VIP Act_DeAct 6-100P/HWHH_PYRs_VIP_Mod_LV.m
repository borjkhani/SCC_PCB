...
saveas(gcf,'L_PYRs_VIP_Mod_Act.tif')
saveas(gcf,'L_PYRs_VIP_Mod_Act.fig')
saveas(gcf,'L_PYRs_VIP_Mod_Act.eps','psc2')
...
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'L_PYRs_VIP_Mod_DeAct.tif')
saveas(gcf,'L_PYRs_VIP_Mod_DeAct.fig')
saveas(gcf,'L_PYRs_VIP_Mod_DeAct.eps','psc2')

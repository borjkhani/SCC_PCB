...
skipNum = [510]; %[24,506,VIP,Sst];
%
for Cell_Number = 473 %1:510 %PVs %1:510 % Number of Cells to be Analysed 
...
run Function_Slow_Plot.m %('C:\Users\Mehdi\Downloads\Model 8\Matlab Analysis Andrzej\Run_One_PYRs_Just_VIP.m')
%close all
clc
...
FA_All=figure;
P1=plot(F_PYRs_C); hold on;
P2=plot(F_PYRs_VIP_Act_06P); hold on;
P3=plot(F_PYRs_VIP_Act_12P); hold on;
P4=plot(F_PYRs_VIP_Act_18P); hold on;
P5=plot(F_PYRs_VIP_Act_25P); hold on;
P6=plot(F_PYRs_VIP_Act_50P); hold on;
P7=plot(F_PYRs_VIP_Act_75P); hold on;
P8=plot(F_PYRs_VIP_Act_100P); hold on;
%P9=plot(F_PYRs_VIP_DeAct); hold on;
...
axis tight;
%legend ('Control', '', 'PV_A_c_t_1_0_0_%', '', 'PV_D_e_A_c_t', '')
legend ('Control', 'VIP_A_c_t_0_6_%', 'VIP_A_c_t_1_2_%', 'VIP_A_c_t_1_8_%', 'VIP_A_c_t_2_5_%', 'VIP_A_c_t_5_0_%', 'VIP_A_c_t_7_5_%', 'VIP_A_c_t_1_0_0_%') %, 'VIP_D_e_A_c_t', '')
...
% save HWHH_VIP_Act.mat H_C H_VIP_Act_06P H_VIP_Act_12P H_VIP_Act_18P H_VIP_Act_25P H_VIP_Act_50P H_VIP_Act_75P H_VIP_Act_100P H_VIP_DeAct
% save Gof_VIP_Act.mat  Gof_PYRs_C  Gof_PYRs_VIP_Act_06P Gof_PYRs_VIP_Act_12P Gof_PYRs_VIP_Act_18P Gof_PYRs_VIP_Act_25P Gof_PYRs_VIP_Act_50P Gof_PYRs_VIP_Act_75P Gof_PYRs_VIP_Act_100P Gof_PYRs_VIP_DeAct 
...
saveas(gcf,'L_PVs_Sst_Mod_Act.tif')
saveas(gcf,'L_PVs_Sst_Mod_Act.fig')
saveas(gcf,'L_PVs_Sst_Mod_Act.eps','psc2')
...
saveas(gcf,'L_PVs_Sst_Mod_DeAct.tif')
saveas(gcf,'L_PVs_Sst_Mod_DeAct.fig')
saveas(gcf,'L_PVs_Sst_Mod_DeAct.eps','psc2')

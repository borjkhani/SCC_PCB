...
if h_50==1
hold on
plot(xt([1 6]), [1 1]*max(yt)*1.140, '-k',  mean(xt([1 8])), max(yt)*1.159, '*k')
end
...
mean1 = mean(H_Sst_Act_06P1_VIP);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_Sst_Act_12P1_VIP);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_Sst_Act_18P1_VIP);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_Sst_Act_25P1_VIP);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_Sst_Act_50P1_VIP);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_Sst_Act_75P1_VIP);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_Sst_Act_100P1_VIP);
...
%
t=text(1, 9, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
% t=text(1, 18, ['Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 17, ['r  = ' num2str(r(1,2))]);
% t=text(1, 16, ['p = ' num2str(p(1,2))]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
saveas(gcf,'FR_L_VIP_Sst_Mod_Act_BW.tif')
saveas(gcf,'FR_L_VIP_Sst_Mod_Act_BW.png')
saveas(gcf,'FR_L_VIP_Sst_Mod_Act_BW.fig')
saveas(gcf,'FR_L_VIP_Sst_Mod_Act_BW.eps','psc2')
%
%%
figure;
...
med1 = median(H_Sst_DeAct_06P1_VIP);
plot(2,med1,'ro-','Color','k'); hold on;

med2 = median(H_Sst_DeAct_12P1_VIP);
plot(3,med2,'ro-','Color','k'); hold on;

med3 = median(H_Sst_DeAct_18P1_VIP);
plot(4,med3,'ro-','Color','k'); hold on;

med4 = median(H_Sst_DeAct_25P1_VIP);
plot(5,med4,'ro-','Color','k'); hold on;

med5 = median(H_Sst_DeAct_50P1_VIP);
plot(6,med5,'ro-','Color','k'); hold on;

med6 = median(H_Sst_DeAct_75P1_VIP);
plot(7,med6,'ro-','Color','k'); hold on;

med7 = median(H_Sst_DeAct_100P1_VIP);
plot(8,med7,'ro-','Color','k'); hold on;
...
mean1 = mean(H_Sst_DeAct_06P1_VIP);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_Sst_DeAct_12P1_VIP);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_Sst_DeAct_18P1_VIP);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_Sst_DeAct_25P1_VIP);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_Sst_DeAct_50P1_VIP);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_Sst_DeAct_75P1_VIP);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_Sst_DeAct_100P1_VIP);
plot(8,mean7,'*','Color','g'); hold on;
...
saveas(gcf,'FR_L_VIP_Sst_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_VIP_Sst_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_VIP_Sst_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_VIP_Sst_Mod_DeAct_BW.eps','psc2')
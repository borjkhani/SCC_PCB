...
saveas(gcf,'L_Sst_VIP_Mod_Act_BW.tif')
saveas(gcf,'L_Sst_VIP_Mod_Act_BW.png')
saveas(gcf,'L_Sst_VIP_Mod_Act_BW.fig')
saveas(gcf,'L_Sst_VIP_Mod_Act_BW.eps','psc2')
%%
figure;
...
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'L_Sst_VIP_Mod_DeAct_BW.tif')
saveas(gcf,'L_Sst_VIP_Mod_DeAct_BW.png')
saveas(gcf,'L_Sst_VIP_Mod_DeAct_BW.fig')
saveas(gcf,'L_Sst_VIP_Mod_DeAct_BW.eps','psc2')

...
saveas(gcf,'L_PVs_VIP_Mod_Act_BW.tif')
saveas(gcf,'L_PVs_VIP_Mod_Act_BW.png')
saveas(gcf,'L_PVs_VIP_Mod_Act_BW.fig')
saveas(gcf,'L_PVs_VIP_Mod_Act_BW.eps','psc2')
%%
figure;
...
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'L_PVs_VIP_Mod_DeAct_BW.tif')
saveas(gcf,'L_PVs_VIP_Mod_DeAct_BW.png')
saveas(gcf,'L_PVs_VIP_Mod_DeAct_BW.fig')
saveas(gcf,'L_PVs_VIP_Mod_DeAct_BW.eps','psc2')
...
saveas(gcf,'CA_PVs_VIP_Mod_DeAct.tif')
saveas(gcf,'CA_PVs_VIP_Mod_DeAct.png')
saveas(gcf,'CA_PVs_VIP_Mod_DeAct.fig')
saveas(gcf,'CA_PVs_VIP_Mod_DeAct.eps','psc2')

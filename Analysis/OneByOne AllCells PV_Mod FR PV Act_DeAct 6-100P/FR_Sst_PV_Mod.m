...
H_PV_Act_06P_Sst(H_PV_Act_06P_Sst>Thr)=NaN;
H_PV_Act_12P_Sst(H_PV_Act_12P_Sst>Thr)=NaN;
H_PV_Act_18P_Sst(H_PV_Act_18P_Sst>Thr)=NaN;
H_PV_Act_25P_Sst(H_PV_Act_25P_Sst>Thr)=NaN;
H_PV_Act_50P_Sst(H_PV_Act_50P_Sst>Thr)=NaN;
H_PV_Act_75P_Sst(H_PV_Act_75P_Sst>Thr)=NaN;
H_PV_Act_100P_Sst(H_PV_Act_100P_Sst>Thr)=NaN;

H_PV_DeAct_06P_Sst(H_PV_DeAct_06P_Sst>Thr)=NaN;
H_PV_DeAct_12P_Sst(H_PV_DeAct_12P_Sst>Thr)=NaN;
H_PV_DeAct_18P_Sst(H_PV_DeAct_18P_Sst>Thr)=NaN;
H_PV_DeAct_25P_Sst(H_PV_DeAct_25P_Sst>Thr)=NaN;
H_PV_DeAct_50P_Sst(H_PV_DeAct_50P_Sst>Thr)=NaN;
H_PV_DeAct_75P_Sst(H_PV_DeAct_75P_Sst>Thr)=NaN;
H_PV_DeAct_100P_Sst(H_PV_DeAct_100P_Sst>Thr)=NaN;
...
% 
% H_PV_DeAct_06P1_Sst=nonzeros(H_PV_DeAct_06P_Sst);
% H_PV_DeAct_12P1_Sst=nonzeros(H_PV_DeAct_12P_Sst);
% H_PV_DeAct_18P1_Sst=nonzeros(H_PV_DeAct_18P_Sst);
% H_PV_DeAct_25P1_Sst=nonzeros(H_PV_DeAct_25P_Sst);
% H_PV_DeAct_50P1_Sst=nonzeros(H_PV_DeAct_50P_Sst);
% H_PV_DeAct_75P1_Sst=nonzeros(H_PV_DeAct_75P_Sst);
% H_PV_DeAct_100P1_Sst=nonzeros(H_PV_DeAct_100P_Sst);

H_C1_Sst=H_C_Sst;
H_PV_Act_06P1_Sst=H_PV_Act_06P_Sst;
H_PV_Act_12P1_Sst=H_PV_Act_12P_Sst;
H_PV_Act_18P1_Sst=H_PV_Act_18P_Sst;
H_PV_Act_25P1_Sst=H_PV_Act_25P_Sst;
H_PV_Act_50P1_Sst=H_PV_Act_50P_Sst;
H_PV_Act_75P1_Sst=H_PV_Act_75P_Sst;
H_PV_Act_100P1_Sst=H_PV_Act_100P_Sst;

H_PV_DeAct_06P1_Sst=H_PV_DeAct_06P_Sst;
H_PV_DeAct_12P1_Sst=H_PV_DeAct_12P_Sst;
H_PV_DeAct_18P1_Sst=H_PV_DeAct_18P_Sst;
H_PV_DeAct_25P1_Sst=H_PV_DeAct_25P_Sst;
H_PV_DeAct_50P1_Sst=H_PV_DeAct_50P_Sst;
H_PV_DeAct_75P1_Sst=H_PV_DeAct_75P_Sst;
H_PV_DeAct_100P1_Sst=H_PV_DeAct_100P_Sst;

%%
H_C1_Sst=H_C1_Sst(~isnan(H_C1_Sst));

H_PV_Act_06P1_Sst=H_PV_Act_06P1_Sst(~isnan(H_PV_Act_06P1_Sst));
H_PV_Act_12P1_Sst=H_PV_Act_12P1_Sst(~isnan(H_PV_Act_12P1_Sst));
H_PV_Act_18P1_Sst=H_PV_Act_18P1_Sst(~isnan(H_PV_Act_18P1_Sst));
H_PV_Act_25P1_Sst=H_PV_Act_25P1_Sst(~isnan(H_PV_Act_25P1_Sst));
H_PV_Act_50P1_Sst=H_PV_Act_50P1_Sst(~isnan(H_PV_Act_50P1_Sst));
H_PV_Act_75P1_Sst=H_PV_Act_75P1_Sst(~isnan(H_PV_Act_75P1_Sst));
H_PV_Act_100P1_Sst=H_PV_Act_100P1_Sst(~isnan(H_PV_Act_100P1_Sst));

H_PV_DeAct_06P1_Sst=H_PV_DeAct_06P1_Sst(~isnan(H_PV_DeAct_06P1_Sst));
H_PV_DeAct_12P1_Sst=H_PV_DeAct_12P1_Sst(~isnan(H_PV_DeAct_12P1_Sst));
H_PV_DeAct_18P1_Sst=H_PV_DeAct_18P1_Sst(~isnan(H_PV_DeAct_18P1_Sst));
H_PV_DeAct_25P1_Sst=H_PV_DeAct_25P1_Sst(~isnan(H_PV_DeAct_25P1_Sst));
H_PV_DeAct_50P1_Sst=H_PV_DeAct_50P1_Sst(~isnan(H_PV_DeAct_50P1_Sst));
H_PV_DeAct_75P1_Sst=H_PV_DeAct_75P1_Sst(~isnan(H_PV_DeAct_75P1_Sst));
H_PV_DeAct_100P1_Sst=H_PV_DeAct_100P1_Sst(~isnan(H_PV_DeAct_100P1_Sst));
...
%  M3=mean(H_PV_DeAct);
 ...
 M9=mean(H_PV_DeAct_06P1_Sst);
 M10=mean(H_PV_DeAct_12P1_Sst);
 M11=mean(H_PV_DeAct_18P1_Sst);
 M12=mean(H_PV_DeAct_25P1_Sst);
 M13=mean(H_PV_DeAct_50P1_Sst);
 M14=mean(H_PV_DeAct_75P1_Sst);
 M15=mean(H_PV_DeAct_100P1_Sst);
 %M=mean(mean(H_C));
...
x=9;
%x=1:8
 y = mean(H_PV_DeAct_06P1_Sst);
 N = size(H_PV_DeAct_06P1_Sst,1);
 SEM = std(H_PV_DeAct_06P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=10;
%x=1:8
 y = mean(H_PV_DeAct_12P1_Sst);
 N = size(H_PV_DeAct_12P1_Sst,1);
 SEM = std(H_PV_DeAct_12P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=11;
%x=1:8
 y = mean(H_PV_DeAct_18P1_Sst);
 N = size(H_PV_DeAct_18P1_Sst,1);
 SEM = std(H_PV_DeAct_18P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=12;
%x=1:8
 y = mean(H_PV_DeAct_25P1_Sst);
 N = size(H_PV_DeAct_25P1_Sst,1);
 SEM = std(H_PV_DeAct_25P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=13;
%x=1:8
 y = mean(H_PV_DeAct_50P1_Sst);
 N = size(H_PV_DeAct_50P1_Sst,1);
 SEM = std(H_PV_DeAct_50P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E3=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=14;
%x=1:8
 y = mean(H_PV_DeAct_75P1_Sst);
 N = size(H_PV_DeAct_75P1_Sst,1);
 SEM = std(H_PV_DeAct_75P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E4=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=15;
%x=1:8
 y = mean(H_PV_DeAct_100P1_Sst);
 N = size(H_PV_DeAct_100P1_Sst,1);
 SEM = std(H_PV_DeAct_100P1_Sst / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E5=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
T9=length(H_PV_DeAct_06P1_Sst)
T10=length(H_PV_DeAct_12P1_Sst)
T11=length(H_PV_DeAct_18P1_Sst)
T12=length(H_PV_DeAct_25P1_Sst)
T13=length(H_PV_DeAct_50P1_Sst)
T14=length(H_PV_DeAct_75P1_Sst)
T15=length(H_PV_DeAct_100P1_Sst)

H=[H_C1_Sst' H_PV_Act_06P1_Sst' H_PV_Act_12P1_Sst' H_PV_Act_18P1_Sst' H_PV_Act_25P1_Sst' H_PV_Act_50P1_Sst' H_PV_Act_75P1_Sst' H_PV_Act_100P1_Sst' H_PV_DeAct_06P1_Sst' H_PV_DeAct_12P1_Sst' H_PV_DeAct_18P1_Sst' H_PV_DeAct_25P1_Sst' H_PV_DeAct_50P1_Sst' H_PV_DeAct_75P1_Sst' H_PV_DeAct_100P1_Sst'];
...
[h_100,p_100] = ttest2(H_C1_Sst,H_PV_Act_100P1_Sst) %H_C1,H_PV_Act1 

[h_06_DeAct,p_06_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_06P1_Sst) %H_C1,H_PV_DeAct1 
[h_12_DeAct,p_12_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_12P1_Sst) %H_C1,H_PV_DeAct1 
[h_18_DeAct,p_18_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_18P1_Sst) %H_C1,H_PV_DeAct1 
[h_25_DeAct,p_25_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_25P1_Sst) %H_C1,H_PV_DeAct1 
[h_50_DeAct,p_50_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_50P1_Sst) %H_C1,H_PV_DeAct1 
[h_75_DeAct,p_75_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_75P1_Sst) %H_C1,H_PV_DeAct1 
[h_100_DeAct,p_100_DeAct] = ttest2(H_C1_Sst,H_PV_DeAct_100P1_Sst) %H_C1,H_PV_DeAct1 
...
med8 = median(H_PV_DeAct_06P1_Sst);
plot(9,med8,'ro-','Color','k'); hold on;

med9 = median(H_PV_DeAct_12P1_Sst);
plot(10,med9,'ro-','Color','k'); hold on;

med10 = median(H_PV_DeAct_18P1_Sst);
plot(11,med10,'ro-','Color','k'); hold on;

med11 = median(H_PV_DeAct_25P1_Sst);
plot(12,med11,'ro-','Color','k'); hold on;

med12 = median(H_PV_DeAct_50P1_Sst);
plot(13,med12,'ro-','Color','k'); hold on;

med13 = median(H_PV_DeAct_75P1_Sst);
plot(14,med13,'ro-','Color','k'); hold on;

med14 = median(H_PV_DeAct_100P1_Sst);
...
saveas(gcf,'FR_Sst_PV_Mod.tif')
saveas(gcf,'FR_Sst_PV_Mod.fig')
saveas(gcf,'FR_Sst_PV_Mod.eps','psc2')
%%
figure;
...
set(gcf, 'Units', 'Inches', 'Position', [0, 0, 5.83*2, 4.38*2], 'PaperUnits', 'Inches', 'PaperSize', [5.83*2, 4.38*2])
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'FR_Sst_PV_Mod_Act.tif')
saveas(gcf,'FR_Sst_PV_Mod_Act.fig')
saveas(gcf,'FR_Sst_PV_Mod_Act.eps','psc2')
...
H=[H_C1_Sst' H_PV_DeAct_06P1_Sst' H_PV_DeAct_12P1_Sst' H_PV_DeAct_18P1_Sst'  H_PV_DeAct_25P1_Sst' H_PV_DeAct_50P1_Sst' H_PV_DeAct_75P1_Sst' H_PV_DeAct_100P1_Sst' ];
...
set(gcf, 'Units', 'Inches', 'Position', [0, 0, 5.83*2, 4.38*2], 'PaperUnits', 'Inches', 'PaperSize', [5.83*2, 4.38*2])
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'FR_Sst_PV_Mod_DeAct.tif')
saveas(gcf,'FR_Sst_PV_Mod_DeAct.fig')
saveas(gcf,'FR_Sst_PV_Mod_DeAct.eps','psc2')

clearvars -except Pref_F_PYRs_PV_Act_100P H_C PKS H_PV_Act_06P H_PV_Act_12P H_PV_Act_18P H_PV_Act_25P H_PV_Act_50P H_PV_Act_75P H_PV_Act_100P H_PV_DeAct skipNum Gof_PYRs_C  Gof_PYRs_PV_Act_06P Gof_PYRs_PV_Act_12P Gof_PYRs_PV_Act_18P Gof_PYRs_PV_Act_25P Gof_PYRs_PV_Act_50P Gof_PYRs_PV_Act_75P Gof_PYRs_PV_Act_100P Gof_PYRs_PV_DeAct  H_PV_DeAct_06P H_PV_DeAct_12P H_PV_DeAct_18P H_PV_DeAct_25P H_PV_DeAct_50P H_PV_DeAct_75P H_PV_DeAct_100P  skipNum Gof_PYRs_C  Gof_PYRs_PV_DeAct_06P Gof_PYRs_PV_DeAct_12P Gof_PYRs_PV_DeAct_18P Gof_PYRs_PV_DeAct_25P Gof_PYRs_PV_DeAct_50P Gof_PYRs_PV_DeAct_75P Gof_PYRs_PV_DeAct_100P  pks locs PKS_C PKS_PV_Act_06P PKS_PV_Act_12P PKS_PV_Act_18P PKS_PV_Act_25P PKS_PV_Act_50P PKS_PV_Act_75P PKS_PV_Act_100P  PKS_PV_DeAct_06P PKS_PV_DeAct_12P PKS_PV_DeAct_18P PKS_PV_DeAct_25P PKS_PV_DeAct_50P PKS_PV_DeAct_75P PKS_PV_DeAct_100P
%clearvars -except Pref_F_PYRs_PV_Act_100P
%clear
% clc
close all
...
% PP=0;
% if all(BB_PV_DeAct<=0)
%     BB_PV_DeAct=BB_Control;
% end

if all(BB_PV_DeAct_06P<=0)
    BB_PV_DeAct_06P=BB_Control;
end

if all(BB_PV_DeAct_12P<=0)
    BB_PV_DeAct_12P=BB_Control;
end

if all(BB_PV_DeAct_18P<=0)
    BB_PV_DeAct_18P=BB_Control;
end

PP=0;
if all(BB_PV_DeAct_25P<=0)
    BB_PV_DeAct_25P=BB_Control;
end

PP=0;
if all(BB_PV_DeAct_50P<=0)
    BB_PV_DeAct_50P=BB_Control;
end

PP=0;
if all(BB_PV_DeAct_75P<=0)
    BB_PV_DeAct_75P=BB_Control;
end
...
% BB_PV_DeAct(isnan(BB_PV_DeAct))=0;

BB_PV_DeAct_06P(isnan(BB_PV_DeAct_06P))=0;
BB_PV_DeAct_12P(isnan(BB_PV_DeAct_12P))=0;
BB_PV_DeAct_18P(isnan(BB_PV_DeAct_18P))=0;
BB_PV_DeAct_25P(isnan(BB_PV_DeAct_25P))=0;
BB_PV_DeAct_50P(isnan(BB_PV_DeAct_50P))=0;
BB_PV_DeAct_75P(isnan(BB_PV_DeAct_75P))=0;
...
% yy=mean(BB_PV_DeAct);
% [f_PYRs_PV_DeAct, gof_PYRs_PV_DeAct] = fit(xx.',yy.','gauss1');
% %P6=plot(f_PYRs_PV_DeAct);
% % hold on;

yy=mean(BB_PV_DeAct_06P);
[f_PYRs_PV_DeAct_06P, gof_PYRs_PV_DeAct_06P] = fit(xx.',yy.','gauss1');

yy=mean(BB_PV_DeAct_12P);
[f_PYRs_PV_DeAct_12P, gof_PYRs_PV_DeAct_12P] = fit(xx.',yy.','gauss1');

yy=mean(BB_PV_DeAct_18P);
[f_PYRs_PV_DeAct_18P, gof_PYRs_PV_DeAct_18P] = fit(xx.',yy.','gauss1');

%%% Correction Code

yy_c=yy;
if f_PYRs_PV_DeAct_18P.b1 < 8 
    %delete(P3)
    yy_c(1,7)=yy(1,7)*0.8;
    [f_PYRs_PV_DeAct_18P, gof_PYRs_PV_DeAct_18P] = fit(xx.',yy_c.','gauss1');
    %P3=plot(f_PYRs_PV_DeAct_18P);
end


yy=mean(BB_PV_DeAct_25P);
[f_PYRs_PV_DeAct_25P, gof_PYRs_PV_DeAct_25P] = fit(xx.',yy.','gauss1');
%P2=plot(f_PYRs_PV_DeAct_25P);
% hold on;

%%% Correction Code

yy_c=yy;
if f_PYRs_PV_DeAct_25P.b1 < 8 
    %delete(P3)
    yy_c(1,7)=yy(1,7)*0.7;
    [f_PYRs_PV_DeAct_25P, gof_PYRs_PV_DeAct_25P] = fit(xx.',yy_c.','gauss1');
    %P3=plot(f_PYRs_PV_DeAct_18P);
end


yy=mean(BB_PV_DeAct_50P);
[f_PYRs_PV_DeAct_50P, gof_PYRs_PV_DeAct_50P] = fit(xx.',yy.','gauss1');
%P3=plot(f_PYRs_PV_DeAct_50P);
% hold on;

%%% Correction Code

yy_c=yy;
if f_PYRs_PV_DeAct_50P.b1 < 8 
    %delete(P3)
    yy_c(1,7)=yy(1,7)*0.7;
    [f_PYRs_PV_DeAct_50P, gof_PYRs_PV_DeAct_50P] = fit(xx.',yy_c.','gauss1');
    %P3=plot(f_PYRs_PV_DeAct_18P);
end


yy=mean(BB_PV_DeAct_75P);
[f_PYRs_PV_DeAct_75P, gof_PYRs_PV_DeAct_75P] = fit(xx.',yy.','gauss1');
%P4=plot(f_PYRs_PV_DeAct_75P);
% hold on;

%%% Correction Code

yy_c=yy;
if f_PYRs_PV_DeAct_75P.b1 < 8 
    %delete(P3)
    yy_c(1,7)=yy(1,7)*0.7;
    [f_PYRs_PV_DeAct_75P, gof_PYRs_PV_DeAct_75P] = fit(xx.',yy_c.','gauss1');
    %P3=plot(f_PYRs_PV_DeAct_18P);
end

yy=mean(BB_PV_DeAct_100P);
[f_PYRs_PV_DeAct_100P, gof_PYRs_PV_DeAct_100P] = fit(xx.',yy.','gauss1');
%P5=plot(f_PYRs_PV_DeAct_100P);
% hold on;

%%% Correction Code

yy_c=yy;
if f_PYRs_PV_DeAct_100P.b1 < 8 
    %delete(P3)
    yy_c(1,7)=yy(1,7)*0.7;
    [f_PYRs_PV_DeAct_100P, gof_PYRs_PV_DeAct_100P] = fit(xx.',yy_c.','gauss1');
    %P3=plot(f_PYRs_PV_DeAct_18P);
end

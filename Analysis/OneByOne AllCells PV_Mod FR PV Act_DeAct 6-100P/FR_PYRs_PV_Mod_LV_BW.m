...
T=[zeros(1,T1),1.5*ones(1,T2),2*ones(1,T3),3*ones(1,T4),4*ones(1,T5),5*ones(1,T6),6*ones(1,T7),7*ones(1,T8)] %,8*ones(1,T9),9*ones(1,T10),10*ones(1,T11),11*ones(1,T12),12*ones(1,T13),13*ones(1,T14),14*ones(1,T15)];
...
save Med_PYRs_PV_Mod_Act.mat Med
...
%
mean0 = mean(H_C1_PYRs);
plot(1,mean0,'*','Color','g'); hold on

mean1 = mean(H_PV_Act_06P1_PYRs);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_PV_Act_12P1_PYRs);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_PV_Act_18P1_PYRs);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_PV_Act_25P1_PYRs);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_PV_Act_50P1_PYRs);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_PV_Act_75P1_PYRs);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_PV_Act_100P1_PYRs);
...
if h_75==1
hold on
plot(xt([1 7]), [1 1]*max(yt)*1.145, '-k' )%,  mean(xt([1 7])), max(yt)*1.159, '*k')
end
...
%
t=text(1, 16, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
% t=text(1, 41, ['Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 40, ['r  = ' num2str(r(1,2))]);
% t=text(1, 39, ['p = ' num2str(p(1,2))]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
saveas(gcf,'FR_L_PYRs_PV_Mod_Act_BW.tif')
saveas(gcf,'FR_L_PYRs_PV_Mod_Act_BW.png')
saveas(gcf,'FR_L_PYRs_PV_Mod_Act_BW.fig')
saveas(gcf,'FR_L_PYRs_PV_Mod_Act_BW.eps','psc2')
%%
figure;
...
med1 = median(H_PV_DeAct_06P1_PYRs);
plot(1,med1,'ro-','Color','k'); hold on;

med2 = median(H_PV_DeAct_12P1_PYRs);
plot(2,med2,'ro-','Color','k'); hold on;

med3 = median(H_PV_DeAct_18P1_PYRs);
plot(3,med3,'ro-','Color','k'); hold on;

med4 = median(H_PV_DeAct_25P1_PYRs);
plot(4,med4,'ro-','Color','k'); hold on;

med5 = median(H_PV_DeAct_50P1_PYRs);
plot(5,med5,'ro-','Color','k'); hold on;

med6 = median(H_PV_DeAct_75P1_PYRs);
plot(6,med6,'ro-','Color','k'); hold on;

med7 = median(H_PV_DeAct_100P1_PYRs);
plot(7,med7,'ro-','Color','k'); hold on;


Med=[med med1 med2 med3 med4 med5 med6 med7];
save Med_PYRs_PV_Mod_DeAct.mat Med
plot(Med,'Color','k','LineStyle',':','LineWidth',3 ); hold on;
...
% % saveas(gcf,'0_P_C.tif')
% 
% saveas(gcf,'L_PYRs_PV_Mod_DeAct_BW.tif')
% saveas(gcf,'L_PYRs_PV_Mod_DeAct_BW.png')
% saveas(gcf,'L_PYRs_PV_Mod_DeAct_BW.fig')
% saveas(gcf,'L_PYRs_PV_Mod_DeAct_BW.eps','psc2')
...
mean1 = mean(H_PV_DeAct_06P1_PYRs);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_PV_DeAct_12P1_PYRs);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_PV_DeAct_18P1_PYRs);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_PV_DeAct_25P1_PYRs);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_PV_DeAct_50P1_PYRs);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_PV_DeAct_75P1_PYRs);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_PV_DeAct_100P1_PYRs);
plot(8,mean7,'*','Color','g'); hold on;
...
%
t=text(1, 45, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
% t=text(1, 31, ['Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 30, ['r  = ' num2str(r(1,2))]);
% t=text(1, 29, ['p = ' num2str(p(1,2))]);
%t.FontSize = 11;

% plot(YY,'LineWidth',2,"MarkerEdgeColor","b", ...
...
% fname = 'C:\Users\Mehdi\Downloads\Matlab Analysis 13 14 16\Matlab Analysis All\Post_Analysis after Create Data FR updated\FR_PV_Mod_Pic';
% filename= 'FR_L_PYRs_PV_Mod_DeAct_BW';
% 
...
saveas(gcf,'FR_L_PYRs_PV_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_PYRs_PV_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_PYRs_PV_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_PYRs_PV_Mod_DeAct_BW.eps','psc2')

...
save Med_Sst_PV_Mod_Act.mat Med
...
mean1 = mean(H_PV_Act_06P1_Sst);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_PV_Act_12P1_Sst);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_PV_Act_18P1_Sst);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_PV_Act_25P1_Sst);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_PV_Act_50P1_Sst);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_PV_Act_75P1_Sst);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_PV_Act_100P1_Sst);
...
%
t=text(1, 26, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
%t=text(1, 26, ['Y = ' num2str(p2(1,1)), ' * X + ' num2str(p2(1,2)) ]);
% t=text(1, 25, ['r  = ' num2str(r(1,2))]);
% t=text(1, 24, ['p = ' num2str(p(1,2))]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%%
...
saveas(gcf,'FR_L_Sst_PV_Mod_Act_BW.tif')
saveas(gcf,'FR_L_Sst_PV_Mod_Act_BW.png')
saveas(gcf,'FR_L_Sst_PV_Mod_Act_BW.fig')
saveas(gcf,'FR_L_Sst_PV_Mod_Act_BW.eps','psc2')
...
save Med_Sst_PV_Mod_DeAct.mat Med
plot(Med,'Color','k','LineStyle',':','LineWidth',3 ); hold on;
%%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mean1 = mean(H_PV_DeAct_06P1_Sst);
plot(2,mean1,'*','Color','g'); hold on;

mean2 = mean(H_PV_DeAct_12P1_Sst);
plot(3,mean2,'*','Color','g'); hold on;

mean3 = mean(H_PV_DeAct_18P1_Sst);
plot(4,mean3,'*','Color','g'); hold on;

mean4 = mean(H_PV_DeAct_25P1_Sst);
plot(5,mean4,'*','Color','g'); hold on;

mean5 = mean(H_PV_DeAct_50P1_Sst);
plot(6,mean5,'*','Color','g'); hold on;

mean6 = mean(H_PV_DeAct_75P1_Sst);
plot(7,mean6,'*','Color','g'); hold on;

mean7 = mean(H_PV_DeAct_100P1_Sst);
plot(8,mean7,'*','Color','g'); hold on;
...
% saveas(gcf,'0_P_C.tif')
saveas(gcf,'FR_L_Sst_PV_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_Sst_PV_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_Sst_PV_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_Sst_PV_Mod_DeAct_BW.eps','psc2')

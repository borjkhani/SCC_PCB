...
global PKS_C;
global PKS_PV_Act_06P;
global PKS_PV_Act_12P;
global PKS_PV_Act_18P;
global PKS_PV_Act_25P;
global PKS_PV_Act_50P;
global PKS_PV_Act_75P;
global PKS_PV_Act_100P;
global PKS_PV_DeAct;
global PKS_PV_DeAct_06P;
global PKS_PV_DeAct_12P;
global PKS_PV_DeAct_18P;
global PKS_PV_DeAct_25P;
global PKS_PV_DeAct_50P;
global PKS_PV_DeAct_75P;
global PKS_PV_DeAct_100P;
...
PKS_C = zeros(510,1);
PKS_PV_Act_06P = zeros(510,1);
PKS_PV_Act_12P = zeros(510,1);
PKS_PV_Act_18P = zeros(510,1);
PKS_PV_Act_25P = zeros(510,1);
PKS_PV_Act_50P = zeros(510,1);
PKS_PV_Act_75P = zeros(510,1);
PKS_PV_Act_100P = zeros(510,1);
PKS_PV_DeAct = zeros(510,1);
PKS_PV_DeAct_06P = zeros(510,1);
PKS_PV_DeAct_12P = zeros(510,1);
PKS_PV_DeAct_18P = zeros(510,1);
PKS_PV_DeAct_25P = zeros(510,1);
PKS_PV_DeAct_50P = zeros(510,1);
PKS_PV_DeAct_75P = zeros(510,1);
PKS_PV_DeAct_100P = zeros(510,1);
...
skipNum = [86,367,510]; %[24,506,PV,Sst];
%
...
F_PYRs_PV_Act_06P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_12P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_18P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_25P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_50P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_75P_R =  A1*exp(-((X-B1)/C1).^2);
...
F_PYRs_PV_Act_100P_R =  A1*exp(-((X-B1)/C1).^2);
...
if nonzeros(BB_PV_DeAct_06P)
A1 = f_PYRs_PV_DeAct_06P.a1;  %        
B1 = f_PYRs_PV_DeAct_06P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_06P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
end    
F_PYRs_PV_DeAct_06P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_06P_R =  A1*exp(-((X-B1)/C1).^2);

if nonzeros(BB_PV_DeAct_12P)
A1 = f_PYRs_PV_DeAct_12P.a1;  %        
B1 = f_PYRs_PV_DeAct_12P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_12P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
end    
F_PYRs_PV_DeAct_12P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_12P_R =  A1*exp(-((X-B1)/C1).^2);

if nonzeros(BB_PV_DeAct_18P)
A1 = f_PYRs_PV_DeAct_18P.a1;  %        
B1 = f_PYRs_PV_DeAct_18P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_18P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
end    
F_PYRs_PV_DeAct_18P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_18P_R =  A1*exp(-((X-B1)/C1).^2);
 
if nonzeros(BB_PV_DeAct_25P)
A1 = f_PYRs_PV_DeAct_25P.a1;  %        
B1 = f_PYRs_PV_DeAct_25P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_25P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
end    
F_PYRs_PV_DeAct_25P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_25P_R =  A1*exp(-((X-B1)/C1).^2);
 
if nonzeros(BB_PV_DeAct_50P)
A1 = f_PYRs_PV_DeAct_50P.a1;  %        
B1 = f_PYRs_PV_DeAct_50P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_50P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
...
F_PYRs_PV_DeAct_50P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_50P_R =  A1*exp(-((X-B1)/C1).^2);

if nonzeros(BB_PV_DeAct_75P)
A1 = f_PYRs_PV_DeAct_75P.a1;  %        
B1 = f_PYRs_PV_DeAct_75P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_75P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
...
F_PYRs_PV_DeAct_75P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_75P_R =  A1*exp(-((X-B1)/C1).^2);

if nonzeros(BB_PV_DeAct_100P)
A1 = f_PYRs_PV_DeAct_100P.a1;  %        
B1 = f_PYRs_PV_DeAct_100P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_100P.c1;  %   0.9677
else 
A1=0;
B1=0;
C1=0;
...
F_PYRs_PV_DeAct_100P =  A1*exp(-((X-B1)/C1).^2);
...
pks = findpeaks(F_PYRs_PV_Act_06P_R);
if ~isnan(pks)
PKS_PV_Act_06P(Cell_Number,1) = pks;
else
    PKS_PV_Act_06P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_PV_Act_12P_R);
if ~isnan(pks)
PKS_PV_Act_12P(Cell_Number,1) = pks;
else
    PKS_PV_Act_12P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_PV_Act_18P_R);
if ~isnan(pks)
PKS_PV_Act_18P(Cell_Number,1) = pks;
else
  PKS_PV_Act_18P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_PV_Act_50P_R);
if ~isnan(pks)
PKS_PV_Act_50P(Cell_Number,1) = pks;
else
  PKS_PV_Act_50P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_PV_Act_75P_R);
if ~isnan(pks)
PKS_PV_Act_75P(Cell_Number,1) = pks;
else
    PKS_PV_Act_75P(Cell_Number,1) = NaN;
end
...
pks = findpeaks(F_PYRs_PV_Act_100P_R);
if ~isnan(pks)
PKS_PV_Act_100P(Cell_Number,1) = pks;
else
    PKS_PV_Act_100P(Cell_Number,1) = NaN;
end
...
B1 = f_PYRs_PV_DeAct_06P.b1; %    5.54
C1 = f_PYRs_PV_DeAct_06P.c1;  %   0.9677
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_06P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_06P = F_PYRs_PV_DeAct_06P/max(F_PYRs_PV_DeAct_06P);
Steps=11.06;
HWHH_PV_DeAct_06P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_06P(Cell_Number,1) = HWHH_PV_DeAct_06P;
Gof_PYRs_PV_DeAct_06P(Cell_Number,1) = gof_PYRs_PV_DeAct_06P;

pks = findpeaks(F_PYRs_PV_DeAct_06P_R);
if ~isnan(pks)
PKS_PV_DeAct_06P(Cell_Number,1) = pks;
else
    PKS_PV_DeAct_06P(Cell_Number,1) = NaN;
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_12P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_12P = F_PYRs_PV_DeAct_12P/max(F_PYRs_PV_DeAct_12P);
Steps=11.12;
HWHH_PV_DeAct_12P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_12P(Cell_Number,1) = HWHH_PV_DeAct_12P;
Gof_PYRs_PV_DeAct_12P(Cell_Number,1) = gof_PYRs_PV_DeAct_12P;

pks = findpeaks(F_PYRs_PV_DeAct_12P_R);
if ~isnan(pks)
PKS_PV_DeAct_12P(Cell_Number,1) = pks;
else
PKS_PV_DeAct_12P(Cell_Number,1) = NaN;
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_18P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_18P = F_PYRs_PV_DeAct_18P/max(F_PYRs_PV_DeAct_18P);
Steps=11.18;
HWHH_PV_DeAct_18P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_18P(Cell_Number,1) = HWHH_PV_DeAct_18P;
Gof_PYRs_PV_DeAct_18P(Cell_Number,1) = gof_PYRs_PV_DeAct_18P;

pks = findpeaks(F_PYRs_PV_DeAct_18P_R);
if ~isnan(pks)
PKS_PV_DeAct_18P(Cell_Number,1) = pks;
else
    PKS_PV_DeAct_18P(Cell_Number,1) = NaN;
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_25P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_25P = F_PYRs_PV_DeAct_25P/max(F_PYRs_PV_DeAct_25P);
Steps=11.25;
HWHH_PV_DeAct_25P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_25P(Cell_Number,1) = HWHH_PV_DeAct_25P;
Gof_PYRs_PV_DeAct_25P(Cell_Number,1) = gof_PYRs_PV_DeAct_25P;

pks = findpeaks(F_PYRs_PV_DeAct_25P_R);
if ~isnan(pks)
PKS_PV_DeAct_25P(Cell_Number,1) = pks;
else
   PKS_PV_DeAct_25P(Cell_Number,1) = NaN; 
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_50P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_50P = F_PYRs_PV_DeAct_50P/max(F_PYRs_PV_DeAct_50P);
Steps=11.25;
HWHH_PV_DeAct_50P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_50P(Cell_Number,1) = HWHH_PV_DeAct_50P;
Gof_PYRs_PV_DeAct_50P(Cell_Number,1) = gof_PYRs_PV_DeAct_50P;

pks = findpeaks(F_PYRs_PV_DeAct_50P_R);
if ~isnan(pks)
PKS_PV_DeAct_50P(Cell_Number,1) = pks;
else
    PKS_PV_DeAct_50P(Cell_Number,1) = NaN;
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_75P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_75P = F_PYRs_PV_DeAct_75P/max(F_PYRs_PV_DeAct_75P);
Steps=11.25;
HWHH_PV_DeAct_75P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_75P(Cell_Number,1) = HWHH_PV_DeAct_75P;
Gof_PYRs_PV_DeAct_75P(Cell_Number,1) = gof_PYRs_PV_DeAct_75P;

pks = findpeaks(F_PYRs_PV_DeAct_75P_R);
if ~isnan(pks)
PKS_PV_DeAct_75P(Cell_Number,1) = pks;
else
   PKS_PV_DeAct_75P(Cell_Number,1) = NaN;
end
...
%f_PYRs_PV_DeAct(x) =  a1*exp(-((x-b1)/c1)^2)
F_PYRs_PV_DeAct_100P =  A1*exp(-((X-B1)/C1).^2);
F_PYRs_PV_DeAct_100P = F_PYRs_PV_DeAct_100P/max(F_PYRs_PV_DeAct_100P);
Steps=11.25;
HWHH_PV_DeAct_100P= Steps*sqrt(log(2)) * C1;
H_PV_DeAct_100P(Cell_Number,1) = HWHH_PV_DeAct_100P;
Gof_PYRs_PV_DeAct_100P(Cell_Number,1) = gof_PYRs_PV_DeAct_100P;

pks = findpeaks(F_PYRs_PV_DeAct_100P_R);
if ~isnan(pks)
PKS_PV_DeAct_100P(Cell_Number,1) = pks;
else
    PKS_PV_DeAct_100P(Cell_Number,1) = NaN;
end
%% New Plots 3
% FA=figure;
...
save FR_Preferred.mat PKS_C PKS_PV_Act_06P PKS_PV_Act_12P PKS_PV_Act_18P PKS_PV_Act_25P PKS_PV_Act_50P PKS_PV_Act_75P PKS_PV_Act_100P  PKS_PV_DeAct_06P PKS_PV_DeAct_12P PKS_PV_DeAct_18P PKS_PV_DeAct_25P PKS_PV_DeAct_50P PKS_PV_DeAct_75P PKS_PV_DeAct_100P
save HWHH_PV_Act.mat H_C  H_PV_Act_06P H_PV_Act_12P H_PV_Act_18P H_PV_Act_25P H_PV_Act_50P H_PV_Act_75P H_PV_Act_100P  H_PV_DeAct_06P H_PV_DeAct_12P H_PV_DeAct_18P H_PV_DeAct_25P H_PV_DeAct_50P H_PV_DeAct_75P H_PV_DeAct_100P

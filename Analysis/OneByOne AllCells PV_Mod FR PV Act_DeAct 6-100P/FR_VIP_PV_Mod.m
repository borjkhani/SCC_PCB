...
H_PV_Act_06P_VIP(H_PV_Act_06P_VIP>Thr)=NaN;
H_PV_Act_12P_VIP(H_PV_Act_12P_VIP>Thr)=NaN;
H_PV_Act_18P_VIP(H_PV_Act_18P_VIP>Thr)=NaN;
H_PV_Act_25P_VIP(H_PV_Act_25P_VIP>Thr)=NaN;
H_PV_Act_50P_VIP(H_PV_Act_50P_VIP>Thr)=NaN;
H_PV_Act_75P_VIP(H_PV_Act_75P_VIP>Thr)=NaN;
H_PV_Act_100P_VIP(H_PV_Act_100P_VIP>Thr)=NaN;

H_PV_DeAct_06P_VIP(H_PV_DeAct_06P_VIP>Thr)=NaN;
H_PV_DeAct_12P_VIP(H_PV_DeAct_12P_VIP>Thr)=NaN;
H_PV_DeAct_18P_VIP(H_PV_DeAct_18P_VIP>Thr)=NaN;
H_PV_DeAct_25P_VIP(H_PV_DeAct_25P_VIP>Thr)=NaN;
H_PV_DeAct_50P_VIP(H_PV_DeAct_50P_VIP>Thr)=NaN;
H_PV_DeAct_75P_VIP(H_PV_DeAct_75P_VIP>Thr)=NaN;
H_PV_DeAct_100P_VIP(H_PV_DeAct_100P_VIP>Thr)=NaN;


% % Remove Zeros
% H_C1_VIP=nonzeros(H_C_VIP);
% H_PV_Act_06P1_VIP=nonzeros(H_PV_Act_06P_VIP);
% H_PV_Act_12P1_VIP=nonzeros(H_PV_Act_12P_VIP);
% H_PV_Act_18P1_VIP=nonzeros(H_PV_Act_18P_VIP);
% H_PV_Act_25P1_VIP=nonzeros(H_PV_Act_25P_VIP);
% H_PV_Act_50P1_VIP=nonzeros(H_PV_Act_50P_VIP);
% H_PV_Act_75P1_VIP=nonzeros(H_PV_Act_75P_VIP);
% H_PV_Act_100P1_VIP=nonzeros(H_PV_Act_100P_VIP);
% 
% H_PV_DeAct_06P1_VIP=nonzeros(H_PV_DeAct_06P_VIP);
% H_PV_DeAct_12P1_VIP=nonzeros(H_PV_DeAct_12P_VIP);
% H_PV_DeAct_18P1_VIP=nonzeros(H_PV_DeAct_18P_VIP);
% H_PV_DeAct_25P1_VIP=nonzeros(H_PV_DeAct_25P_VIP);
% H_PV_DeAct_50P1_VIP=nonzeros(H_PV_DeAct_50P_VIP);
% H_PV_DeAct_75P1_VIP=nonzeros(H_PV_DeAct_75P_VIP);
% H_PV_DeAct_100P1_VIP=nonzeros(H_PV_DeAct_100P_VIP);


H_C1_VIP=H_C_VIP;
H_PV_Act_06P1_VIP=H_PV_Act_06P_VIP;
H_PV_Act_12P1_VIP=H_PV_Act_12P_VIP;
H_PV_Act_18P1_VIP=H_PV_Act_18P_VIP;
H_PV_Act_25P1_VIP=H_PV_Act_25P_VIP;
H_PV_Act_50P1_VIP=H_PV_Act_50P_VIP;
H_PV_Act_75P1_VIP=H_PV_Act_75P_VIP;
H_PV_Act_100P1_VIP=H_PV_Act_100P_VIP;

H_PV_DeAct_06P1_VIP=H_PV_DeAct_06P_VIP;
H_PV_DeAct_12P1_VIP=H_PV_DeAct_12P_VIP;
H_PV_DeAct_18P1_VIP=H_PV_DeAct_18P_VIP;
H_PV_DeAct_25P1_VIP=H_PV_DeAct_25P_VIP;
H_PV_DeAct_50P1_VIP=H_PV_DeAct_50P_VIP;
H_PV_DeAct_75P1_VIP=H_PV_DeAct_75P_VIP;
H_PV_DeAct_100P1_VIP=H_PV_DeAct_100P_VIP;

%%
H_C1_VIP=H_C1_VIP(~isnan(H_C1_VIP));
H_PV_Act_06P1_VIP=H_PV_Act_06P1_VIP(~isnan(H_PV_Act_06P1_VIP));
H_PV_Act_12P1_VIP=H_PV_Act_12P1_VIP(~isnan(H_PV_Act_12P1_VIP));
H_PV_Act_18P1_VIP=H_PV_Act_18P1_VIP(~isnan(H_PV_Act_18P1_VIP));
H_PV_Act_25P1_VIP=H_PV_Act_25P1_VIP(~isnan(H_PV_Act_25P1_VIP));
H_PV_Act_50P1_VIP=H_PV_Act_50P1_VIP(~isnan(H_PV_Act_50P1_VIP));
H_PV_Act_75P1_VIP=H_PV_Act_75P1_VIP(~isnan(H_PV_Act_75P1_VIP));
H_PV_Act_100P1_VIP=H_PV_Act_100P1_VIP(~isnan(H_PV_Act_100P1_VIP));

H_PV_DeAct_06P1_VIP=H_PV_DeAct_06P1_VIP(~isnan(H_PV_DeAct_06P1_VIP));
H_PV_DeAct_12P1_VIP=H_PV_DeAct_12P1_VIP(~isnan(H_PV_DeAct_12P1_VIP));
H_PV_DeAct_18P1_VIP=H_PV_DeAct_18P1_VIP(~isnan(H_PV_DeAct_18P1_VIP));
H_PV_DeAct_25P1_VIP=H_PV_DeAct_25P1_VIP(~isnan(H_PV_DeAct_25P1_VIP));
H_PV_DeAct_50P1_VIP=H_PV_DeAct_50P1_VIP(~isnan(H_PV_DeAct_50P1_VIP));
H_PV_DeAct_75P1_VIP=H_PV_DeAct_75P1_VIP(~isnan(H_PV_DeAct_75P1_VIP));
H_PV_DeAct_100P1_VIP=H_PV_DeAct_100P1_VIP(~isnan(H_PV_DeAct_100P1_VIP));
...
%  M3=mean(H_PV_DeAct);
 ...
 M1=mean(H_C1_VIP);
 M2=mean(H_PV_Act_06P1_VIP);
 M3=mean(H_PV_Act_12P1_VIP);
 M4=mean(H_PV_Act_18P1_VIP);
 M5=mean(H_PV_Act_25P1_VIP);
 M6=mean(H_PV_Act_50P1_VIP);
 M7=mean(H_PV_Act_75P1_VIP);
 M8=mean(H_PV_Act_100P1_VIP);
 M9=mean(H_PV_DeAct_06P1_VIP);
 M10=mean(H_PV_DeAct_12P1_VIP);
 M11=mean(H_PV_DeAct_18P1_VIP);
 M12=mean(H_PV_DeAct_25P1_VIP);
 M13=mean(H_PV_DeAct_50P1_VIP);
 M14=mean(H_PV_DeAct_75P1_VIP);
 M15=mean(H_PV_DeAct_100P1_VIP);
 %M=mean(mean(H_C));
...
x=2;
%x=1:8
 y = mean(H_PV_Act_06P1_VIP);
 N = size(H_PV_Act_06P1_VIP,1);
 SEM = std(H_PV_Act_06P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=3;
%x=1:8
 y = mean(H_PV_Act_12P1_VIP);
 N = size(H_PV_Act_12P1_VIP,1);
 SEM = std(H_PV_Act_12P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=4;
%x=1:8
 y = mean(H_PV_Act_18P1_VIP);
 N = size(H_PV_Act_18P1_VIP,1);
 SEM = std(H_PV_Act_18P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=5;
%x=1:8
 y = mean(H_PV_Act_25P1_VIP);
 N = size(H_PV_Act_25P1_VIP,1);
 SEM = std(H_PV_Act_25P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=6;
%x=1:8
 y = mean(H_PV_Act_50P1_VIP);
 N = size(H_PV_Act_50P1_VIP,1);
 SEM = std(H_PV_Act_50P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E3=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=7;
%x=1:8
 y = mean(H_PV_Act_75P1_VIP);
 N = size(H_PV_Act_75P1_VIP,1);
 SEM = std(H_PV_Act_75P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
...
x=8;
%x=1:8
 y = mean(H_PV_Act_100P1_VIP);
 N = size(H_PV_Act_100P1_VIP,1);
 SEM = std(H_PV_Act_100P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
...
x=9;
%x=1:8
 y = mean(H_PV_DeAct_06P1_VIP);
 N = size(H_PV_DeAct_06P1_VIP,1);
 SEM = std(H_PV_DeAct_06P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=10;
%x=1:8
 y = mean(H_PV_DeAct_12P1_VIP);
 N = size(H_PV_DeAct_12P1_VIP,1);
 SEM = std(H_PV_DeAct_12P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=11;
%x=1:8
 y = mean(H_PV_DeAct_18P1_VIP);
 N = size(H_PV_DeAct_18P1_VIP,1);
 SEM = std(H_PV_DeAct_18P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=12;
%x=1:8
 y = mean(H_PV_DeAct_25P1_VIP);
 N = size(H_PV_DeAct_25P1_VIP,1);
 SEM = std(H_PV_DeAct_25P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E2=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=13;
%x=1:8
 y = mean(H_PV_DeAct_50P1_VIP);
 N = size(H_PV_DeAct_50P1_VIP,1);
 SEM = std(H_PV_DeAct_50P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E3=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=14;
%x=1:8
 y = mean(H_PV_DeAct_75P1_VIP);
 N = size(H_PV_DeAct_75P1_VIP,1);
 SEM = std(H_PV_DeAct_75P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E4=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
x=15;
%x=1:8
 y = mean(H_PV_DeAct_100P1_VIP);
 N = size(H_PV_DeAct_100P1_VIP,1);
 SEM = std(H_PV_DeAct_100P1_VIP / sqrt(N));
 CI95 = SEM * tinv(0.975, N-1);              % 95% Confidence Intervals
 E5=errorbar(x, y, CI95,'LineWidth',3)
grid off
hold on;
...
%% ttest
[h_06,p_06] = ttest2(H_C1_VIP,H_PV_Act_06P1_VIP) %H_C1,H_PV_Act1 
[h_12,p_12] = ttest2(H_C1_VIP,H_PV_Act_12P1_VIP) %H_C1,H_PV_Act1 
[h_18,p_18] = ttest2(H_C1_VIP,H_PV_Act_18P1_VIP) %H_C1,H_PV_Act1 
[h_25,p_25] = ttest2(H_C1_VIP,H_PV_Act_25P1_VIP) %H_C1,H_PV_Act1 
[h_50,p_50] = ttest2(H_C1_VIP,H_PV_Act_50P1_VIP) %H_C1,H_PV_Act1 
[h_75,p_75] = ttest2(H_C1_VIP,H_PV_Act_75P1_VIP) %H_C1,H_PV_Act1 
[h_100,p_100] = ttest2(H_C1_VIP,H_PV_Act_100P1_VIP) %H_C1,H_PV_Act1 

[h_06_DeAct,p_06_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_06P1_VIP) %H_C1,H_PV_DeAct1 
[h_12_DeAct,p_12_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_12P1_VIP) %H_C1,H_PV_DeAct1 
[h_18_DeAct,p_18_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_18P1_VIP) %H_C1,H_PV_DeAct1 
[h_25_DeAct,p_25_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_25P1_VIP) %H_C1,H_PV_DeAct1 
[h_50_DeAct,p_50_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_50P1_VIP) %H_C1,H_PV_DeAct1 
[h_75_DeAct,p_75_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_75P1_VIP) %H_C1,H_PV_DeAct1 
[h_100_DeAct,p_100_DeAct] = ttest2(H_C1_VIP,H_PV_DeAct_100P1_VIP) %H_C1,H_PV_DeAct1 
...
saveas(gcf,'FR_0_VIP_PV_Mod.tif')
saveas(gcf,'FR_0_VIP_PV_Mod.fig')
saveas(gcf,'FR_0_VIP_PV_Mod.eps','psc2')
...
saveas(gcf,'FR_0_VIP_PV_Mod_Act.tif')
saveas(gcf,'FR_0_VIP_PV_Mod_Act.fig')
saveas(gcf,'FR_0_VIP_PV_Mod_Act.eps','psc2')
%%
figure;
...
saveas(gcf,'FR_0_VIP_PV_Mod_DeAct.tif')
saveas(gcf,'FR_0_VIP_PV_Mod_DeAct.fig')
saveas(gcf,'FR_0_VIP_PV_Mod_DeAct.eps','psc2')

...
if h_75==1
hold on
plot(xt([1 7]), [1 1]*max(yt)*1.145, '-k', mean(xt([1 7])), max(yt)*1.163, '*k')
end

if h_100==1
hold on
plot(xt([1 8]), [1 1]*max(yt)*1.150, '-k', mean(xt([1 8])), max(yt)*1.163, '*k')
end
%
title('PV_A_c_t')
xlabel('Simulations' )
...
saveas(gcf,'FR_L_VIP_PV_Mod_Act_BW.tif')
saveas(gcf,'FR_L_VIP_PV_Mod_Act_BW.png')
saveas(gcf,'FR_L_VIP_PV_Mod_Act_BW.fig')
saveas(gcf,'FR_L_VIP_PV_Mod_Act_BW.eps','psc2')
%%
figure;
...
saveas(gcf,'FR_L_VIP_PV_Mod_DeAct_BW.tif')
saveas(gcf,'FR_L_VIP_PV_Mod_DeAct_BW.png')
saveas(gcf,'FR_L_VIP_PV_Mod_DeAct_BW.fig')
saveas(gcf,'FR_L_VIP_PV_Mod_DeAct_BW.eps','psc2')

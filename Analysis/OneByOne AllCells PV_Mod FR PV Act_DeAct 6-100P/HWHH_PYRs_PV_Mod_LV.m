...
saveas(gcf,'L_PYRs_PV_Mod_Act.tif')
saveas(gcf,'L_PYRs_PV_Mod_Act.fig')
saveas(gcf,'L_PYRs_PV_Mod_Act.eps','psc2')
%%
figure;
...
saveas(gcf,'L_PYRs_PV_Mod_DeAct.tif')
saveas(gcf,'L_PYRs_PV_Mod_DeAct.fig')
saveas(gcf,'L_PYRs_PV_Mod_DeAct.eps','psc2')

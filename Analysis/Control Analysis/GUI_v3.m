function simpleGUI
    ...
    fig = figure('Position', [100, 100, 400, 300], 'Name', 'Analysis GUI', ...
        'NumberTitle', 'off', 'CloseRequestFcn', @closeGUI);

    % Set the font size and type for the buttons
    fontSize = 12;
    fontType = 'Arial'; % You can change this to other fonts like 'Helvetica', 'Times New Roman', etc.
    ...
    uicontrol('Style', 'pushbutton', 'String', 'Load Data', ...
        ...
        'FontSize', fontSize, 'FontName', fontType);

    % Create buttons for each analysis script
    uicontrol('Style', 'pushbutton', 'String', 'Sorting data', ...
        'Position', [50, 180, 300, 40], 'Callback', @runAnalysis1, ...
        'FontSize', fontSize, 'FontName', fontType);

    uicontrol('Style', 'pushbutton', 'String', 'Calculation of HWHH (Fast)', ...
        'Position', [50, 120, 300, 40], 'Callback', @runAnalysis2, ...
        'FontSize', fontSize, 'FontName', fontType);

    uicontrol('Style', 'pushbutton', 'String', 'Comparison', ...

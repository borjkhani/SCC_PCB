...
box off
saveas(gcf,'L_Sst_PV_Mod_Act_KW.tif')
saveas(gcf,'L_Sst_PV_Mod_Act_KW.png')
saveas(gcf,'L_Sst_PV_Mod_Act_KW.fig')
saveas(gcf,'L_Sst_PV_Mod_Act_KW.eps','psc2')
%%
figure;
...
save L_Sst_PV_Mod_Act_KW_St.mat p tbl stats c m h nms
filename = 'L_Sst_PV_Mod_Act_KW_St.xlsx';
...
saveas(gcf,'L_Sst_PV_Mod_Act_KW_St.tif')
saveas(gcf,'L_Sst_PV_Mod_Act_KW_St.png')
saveas(gcf,'L_Sst_PV_Mod_Act_KW_St.fig')
saveas(gcf,'L_Sst_PV_Mod_Act_KW_St.eps','psc2')
%% DeAct
Group = NaN(510,8)
%kruskalwallis()
%
...
ylabel('Sst HWHH ({\circ})')
box off
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW.tif')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW.png')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW.fig')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW.eps','psc2')
%
figure;
...
%PP= array2table(p)
CC.Properties.VariableNames(1:7) = {'1st group','2nd group','Lower (95% confidence)','diff. est. group means','Upper (95% confidence)','P-values','P-value(all)'}
save L_Sst_PV_Mod_DeAct_KW_St.mat p tbl stats c m h nms
filename = 'L_Sst_PV_Mod_DeAct_KW_St.xlsx';
%writematrix(c,filename,'Sheet',1,'Range','D1')
writetable(CC,filename,'Sheet',1,'Range','D1')
%writetable(PP,filename,'Sheet',1,'Range','J2')
...
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW_St.tif')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW_St.png')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW_St.fig')
saveas(gcf,'L_Sst_PV_Mod_DeAct_KW_St.eps','psc2')
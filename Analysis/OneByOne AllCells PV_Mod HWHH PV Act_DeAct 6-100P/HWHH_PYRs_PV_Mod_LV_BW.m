...
saveas(gcf,'L_PYRs_PV_Mod_Act_BW.tif')
saveas(gcf,'L_PYRs_PV_Mod_Act_BW.png')
saveas(gcf,'L_PYRs_PV_Mod_Act_BW.fig')
saveas(gcf,'L_PYRs_PV_Mod_Act_BW.eps','psc2')
%%
figure;
...
%
t=text(1, 29, ['Y=' num2str(p2(1,1)), '*X+' num2str(p2(1,2)) , '\newline', 'r=' num2str(r(1,2)),'\newline', 'p=' num2str(p(1,2)) ], 'FontSize', 8);
